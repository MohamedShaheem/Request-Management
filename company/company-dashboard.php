...
$stmt = $conn->prepare("SELECT Name FROM organizations WHERE OrganizationID = ?");
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?= $page === 'request' ? 'active' : '' ?>" href="company-dashboard.php?page=request">Request Gas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $page === 'request-tracking' ? 'active' : '' ?>" href="company-dashboard.php?page=request-tracking">Request Tracking</a>
                </li>
            </ul>
            <span class="navbar-text me-3">
                Welcome, <a href="profile.php"><span class="fw-bolder text-light"><?= htmlspecialchars($fullName); ?></span></a>
            </span>
            <a href="../b-logout.php" class="btn btn-outline-danger">Logout</a>
        </div>
    </div>
</nav>
...
<div class="container mt-5">
    ...
    $allowed_pages = [ 'request', 'request-tracking'];
