...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($email) || empty($phoneNumber)) {
        ...
        $stmt->execute([$username, $email, $phoneNumber, $userID]);
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?= htmlspecialchars($fullName) ?>" required>
            </div>
            <div class="mb-3">
        ...
        <div class="form-footer mt-3">
            <a href="user-dashboard.php">Cancel</a>
        </div>
    </div>
